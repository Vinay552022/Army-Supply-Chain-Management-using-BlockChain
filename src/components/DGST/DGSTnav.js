...
export default function DGSTnav(props) {
  ...
  >
    ...
    <div className="offcanvas-body">
      ...
      <ul className=" nav navmenu-nav flex-column">
        ...
        <li className="nav-item"><Link className="nav-link" to="/ADSTRegistrationForm">ADST Registration Form</Link></li>
        <li className="nav-item"><Link className="nav-link" to="/DDSTRegistrationForm">DDST Registration Form</Link></li>
